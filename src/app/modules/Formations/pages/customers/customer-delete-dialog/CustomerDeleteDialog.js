...
import { deleteformationApi } from "../../../../../redux_main/actions/formation.actions";
...
export function CustomerDeleteDialog({ id, show, onHide }) {
  ...
  const deleteCustomer = () => {
    ...
    dispatch(deleteformationApi(id));
    onHide();
  };
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        {!isLoading && (
          <span>Est ce que vous etes de supprimer cette Formation?</span>
        )}
