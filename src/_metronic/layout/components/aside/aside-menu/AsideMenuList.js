...
import { LOGOUT_USER } from "../../../../../app/redux_main/actionTypes/actionTypes";
...
export function AsideMenuList({ layoutProps }) {
  ...
  const getMenuItemActive = (url, hasSubmenu = false) => {
    ...
    //   : "";
    return location.pathname == url ? "menu-item-active" : "";
  };
  ...
  return (
    <>
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
          ...
          <>
            ...
            <>
              ...
              <li
                ...
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/users/ste">
                  <span className="svg-icon menu-icon">
                    <SVG
                      src={toAbsoluteUrl("/media/svg/icons/Design/Layers.svg")}
                    />
              ...
              <li
                ...
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/users/center">
                  <span className="svg-icon menu-icon">
                    <SVG
                      src={toAbsoluteUrl("/media/svg/icons/Design/Layers.svg")}
                    />
                  </span>
                  <span className="menu-text">Centre de formation</span>
                </NavLink>
              </li>
              <li
                className={`menu-item ${getMenuItemActive(
                ...
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/users/domain">
                  <span className="svg-icon menu-icon">
                    <SVG
                      src={toAbsoluteUrl("/media/svg/icons/Design/Layers.svg")}
                    />
        ...
        {userInfo && userInfo.role == "STE" && (
          <>
            {" "}
            <li
              className={`menu-item ${getMenuItemActive("/offres", false)}`}
              aria-haspopup="true"
            >
              <NavLink className="menu-link" to="/offres">
                <span className="svg-icon menu-icon">
                  <SVG
                    src={toAbsoluteUrl("/media/svg/icons/Design/Layers.svg")}
                  />
            ...
            <li
              ...
              aria-haspopup="true"
            >
              <NavLink className="menu-link" to="/offres/participation/list">
                <span className="svg-icon menu-icon">
                  <SVG
                    src={toAbsoluteUrl("/media/svg/icons/Design/Layers.svg")}
                  />
          ...
          <>
            ...
            >
              <NavLink className="menu-link" to="/formations">
                ...
                <span className="menu-text">Cours</span>
              </NavLink>
            </li>
            <li
              className={`menu-item ${getMenuItemActive("/offres", false)}`}
          ...
          <div className="menu-submenu">
            ...
            <ul className="menu-subnav">
              ...
              <li
                ...
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/users/products">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
